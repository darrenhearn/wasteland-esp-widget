...
boolean MqttUtil::PublishTemperature(unsigned long timestamp, uint8_t device, float temperature) {
  snprintf(topic_buffer_, kTopicBufferSize, "temperature/%d", device);
